...
Check out Kraken's review system - [Gerrit](https://gerrit.aospk.org).
...
Let's take a [example commit](https://gerrit.aospk.org/#/c/3221/).
...
Start by noting down the URL of the proposed commit. In the above example, it's [https://gerrit.aospk.org/#/c/3221/](https://gerrit.aospk.org/#/c/3221/). That number, `3221` will come in handy in a second.
