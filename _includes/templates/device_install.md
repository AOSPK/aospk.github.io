...
## Installing Kraken from recovery

1. Download the [Kraken installation package](https://download.aospk.org/{{ device.codename }}) that you would like to install or [build]({{ "devices/" | append: device.codename | append: "/build" | relative_url }}) the package yourself.
...
5. Sideload the Kraken `.zip` package:
