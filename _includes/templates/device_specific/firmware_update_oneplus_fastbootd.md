...
3. Boot up Kraken recovery
4. Go to "Advanced" -> "Enter fastboot"
   {% include alerts/warning.html content="The \"Enter fastboot\" option may not be present on older Kraken recovery builds and it cannot be substituted with \"Reboot to bootloader\"." %}
